                  ...
                  <div className="max-h-[140px] overflow-y-auto pr-1 custom-scrollbar rounded-xl glass-light p-3">
                    <div className="grid grid-cols-2 gap-2">
                      {[
                        ...
                        { en: 'Perfect crime', zh: '完美犯罪' },
                        { en: 'Serial killer', zh: '连环杀手' },
                        { en: 'Escape room', zh: '密室逃脱' },
                        { en: 'Toxicology', zh: '毒理学' },
                        { en: 'Identity forgery', zh: '伪造身份' },
                        { en: 'Snowbound villa', zh: '暴风雪山庄' },
                        { en: 'Deep sea submarine', zh: '深海潜艇' },
                        { en: 'Haunted castle', zh: '古堡惊魂' },
                        { en: 'Abandoned hospital', zh: '废弃医院' },
                        { en: 'Tropical rainforest', zh: '热带雨林' },
                        { en: 'Dual personality', zh: '双重人格' },
                        { en: 'Memory fragments', zh: '记忆碎片' },
                        { en: 'Death prophecy', zh: '死亡预言' },
                        { en: 'Cipher message', zh: '密信密码' },
                        { en: 'Time loop', zh: '时间循环' },
                        { en: 'Elite family feud', zh: '豪门恩怨' },
                        { en: 'Corporate espionage', zh: '商业间谍' },
                        { en: 'Academic fraud', zh: '学术造假' },
                        { en: 'Medical malpractice', zh: '医疗事故' },
                        { en: 'Election conspiracy', zh: '选举阴谋' },
                      ].map((t) => (
                        <button
                          key={t.en}
